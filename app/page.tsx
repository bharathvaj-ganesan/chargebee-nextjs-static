      ...
      <div className="relative flex flex-col items-center">
        ...
        <a href="https://chargebee.com" target="_blank" rel="noreferrer">
          <img
            ...
            alt=""
            className="pulse h-24 w-24 cursor-pointer select-none opacity-80 grayscale hue-rotate-15 transition hover:brightness-125 hover:opacity-100 hover:grayscale-0"
          />
        </a>
        <div className="mb-8" />
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-3xl font-light text-gray-100">
            <span className="font-bold text-gray-100">Next.js</span> Website Stack
          </h1>
          <div className="mb-1" />
          ...
          <h1 className="text-center text-8xl font-bold text-gray-200">
            <span
              className="text-primary 
							bg-clip-text transition hover:brightness-125"
            >
              Chargebee
            </span>{' '}
            Subscriptions
        ...
        <div className="flex flex-row items-center">
          <a
            href="https://github.com/bharathvaj-ganesan/chargebee-nextjs-static"
            target="_blank"
            rel="noopener noreferrer"
